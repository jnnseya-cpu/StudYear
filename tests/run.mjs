...
const SUITES = ['auth-test', 'e2ee-test', 'cloud-test', 'prem-test', 'exam-test', 'demo-test', 'admin-test', 'growth-test', 'splash-test', 'record-test', 'data-test', 'lapse-test', 'level-test', 'crawl'];
let failed = 0;
